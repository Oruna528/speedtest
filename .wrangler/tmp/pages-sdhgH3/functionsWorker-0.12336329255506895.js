...
var onRequest = /* @__PURE__ */ __name(async (context2) => {
  ...
  if (url.pathname === "/api/download") {
    const size = parseInt(url.searchParams.get("size") || "8388608");
  ...
  if (url.pathname === "/api/upload") {
    if (context2.request.method === "POST") {
      await context2.request.arrayBuffer();
      return new Response("OK", { status: 200 });
    }
  }
  if (url.pathname === "/api/empty") {
    const cf = context2.request.cf || {};
    const clientIp = context2.request.headers.get("cf-connecting-ip") || "Unknown IP";
...
// ../.wrangler/tmp/pages-sdhgH3/functionsRoutes-0.18707147637877852.mjs
var routes = [
  {
    routePath: "/:path*",
    mountPath: "/",
